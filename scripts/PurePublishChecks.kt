...
fun main() {
    ...
    check(PublishSpeedProfile.INSTANT.betweenGroupsMs == 0L)
    check(PublishSpeedProfile.TURBO.betweenGroupsMs == 1_000L)
    check(PublishSpeedProfile.INSTANT.betweenGroupsMs < PublishSpeedProfile.TURBO.betweenGroupsMs)
    ...
    check(PublishSpeedProfile.entries.all { it.betweenGroupsMs >= 0L })
    ...
    println("PurePublishChecks v2.20: OK")
}
